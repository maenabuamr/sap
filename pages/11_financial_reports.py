...
with tab6:
    ...
    if expenses_df.empty:
        ...
        with fcol3:
            exp_account_names = sorted(expenses_df["اسم الحساب"].dropna().unique().tolist())
            sel_exp_accounts = st.multiselect("نوع المصروف (اسم الحساب):", exp_account_names, default=exp_account_names, key="exp_ac")
        with fcol4:
